...
public class LogsFragment extends BaseListFragment implements LogsDialogListener {
    ...
    @Override
    public void getDataInfo(final List<String> dataInfoList) {
        ...
        if (dataInfoList != null) {
            ...
            myOwnAdapter = new ArrayAdapter<String>(QuiteSleepApp.getContext(), R.layout.logstab,
                    R.id.logstab_textview_contact, dataInfoList);
    ...
    public final Handler handlerRemove = new Handler() {
        ...
        public void handleMessage(final Message message) {
            ...
            int numRemoveCallLogs = message.getData().getInt(ConfigAppValues.NUM_REMOVE_CALL_LOGS);
            ...
            Toast.makeText(
                    ...
                    numRemoveCallLogs + " "
                            + QuiteSleepApp.getContext().getString(R.string.menu_calllog_remove_toast),
    ...
    public final Handler handlerRefresh = new Handler() {
        ...
        public void handleMessage(final Message message) {
            ...
            callLogListString = message.getData().getStringArrayList(ConfigAppValues.REFRESH_CALL_LOG);
            ...
            // Show the toast message
            es.cesar.quitesleep.utils.Toast.d(QuiteSleepApp.getContext(),
                    QuiteSleepApp.getContext().getString(R.string.menu_calllog_refresh_toast), Toast.LENGTH_SHORT);
        }
    };
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_calllog_refresh:
                SherlockDialogFragment refresh = LogsFragmentDialog.newInstance(this,
                        ConfigAppValues.DialogType.REFRESH_ALL_LOGS);
                refresh.show(getSherlockActivity().getSupportFragmentManager(), "warningDialog");
                break;
            case R.id.menu_calllog_remove:
                SherlockDialogFragment clear = LogsFragmentDialog.newInstance(this,
                        ConfigAppValues.DialogType.REMOVE_ALL_LOGS);
