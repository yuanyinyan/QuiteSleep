...
public class AddBannedFragment extends BaseListFragment implements OnItemClickListener, ContactDialogListener {
            ...
            case R.id.menu_addall:
                if (!isAdapterEmpty()) {
                    SherlockDialogFragment dialogFragment = ContactsFragmentDialog.newInstance(this,
                            ConfigAppValues.DialogType.ADD_ALL_CONTACTS);
    ...
    public final Handler handler = new Handler() {
        ...
        public void handleMessage(final Message message) {
            ...
            Toast.d(QuiteSleepApp.getContext(),
                    numBanned + " " + QuiteSleepApp.getContext().getString(R.string.menu_addall_toast_insertscount),
